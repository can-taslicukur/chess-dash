box::use(
    shiny[fluidPage, shinyApp, NS, moduleServer, tagList, tags, fluidRow, tableOutput,
...
getProfileInfoUI <- function(id) {
    ...
    tagList(
        ...
        fluidRow(
            ...
            column(
                width = 10,
                searchInput(inputId = ns("username"),label = "Username",width = "100%",
...
getProfileInfoApp <- function(){
    shinyApp(fluidPage(getProfileInfoUI("getProfileInfo"),tableOutput("out")),
             function(input, output, session) {
